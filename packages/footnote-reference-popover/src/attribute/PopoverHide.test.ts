...
describe('imageWidth', () => {
	...
	test('not number', () => {
		...
		}).toThrow(new Error('The value of the `data-popover-hide-image-width` attribute must be a number'));
	});

	test('zero', () => {
		expect(() => {
			new PopoverHide({ imageWidth: '0' });
		}).toThrow(new Error('The value of the `data-popover-hide-image-width` attribute must be a number greater than zero'));
	});
...
describe('imageHeight', () => {
	...
	test('not number', () => {
		...
		}).toThrow(new Error('The value of the `data-popover-hide-image-height` attribute must be a number'));
	});

	test('zero', () => {
		expect(() => {
			new PopoverHide({ imageHeight: '0' });
		}).toThrow(new Error('The value of the `data-popover-hide-image-height` attribute must be a number greater than zero'));
	});
